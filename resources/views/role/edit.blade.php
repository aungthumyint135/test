            ...
            <form method="post" action="{{ route('roles.update', $role->uuid) }}">
                ...
                <div class="w-full rounded-lg border border-gray-200 bg-white py-24 sm:px-6 sm:py-32 pb-10">
                    <div class="mx-auto max-w-xl">
                        <h2 class="text-base font-semibold leading-7 text-gray-900">Update the role</h2>
                        <p class="mt-1 text-sm leading-6 text-gray-600">This information will be used to assign the
                            staff.</p>
                        <div
                            class="mt-10 grid grid-cols-1 sm:grid-cols-2 space-y-8 border-b border-gray-200 gap-x-6 pb-12">
                            <div class="col-span-full">
                                <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Role
                                    Name</label>
                                <input type="text"
                            ...
                            <div class="col-span-full">
                                <label for="remark"
                                       class="block text-sm font-medium leading-6 text-gray-900">Remark</label>
                                <textarea id="remark"
                                          ...
                                          name="remark">{{ old('remark', $role->remark) }}</textarea>
