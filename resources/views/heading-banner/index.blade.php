<x-app-layout>
    <x-slot name="title">Heading Banner Mgmt</x-slot>
    <div class="w-full" x-data="data">
        <div class="grid w-full grid-cols-1 space-y-5 rounded-lg border border-gray-200 bg-white py-6">
            <div class="flex flex-row justify-end px-4">
                ...
                <x-buttons.primary-link href="{{ route('portal.heading-banners.create') }}">
                    Create
        ...
        <script>
            ...
            function data() {
                return {
                    ...
                    async fetchData() {
                        this.isLoading = true;
                        await axios.get("/heading-banners", {
                            params: {
                                limit: this.view,
                                offset: this.offset,
                    ...
                    async handleConfirmAction() {
                        ...
                        if (this.id) {
                            await fetch(`/heading-banners/${this.id}`, {
                                    method: "DELETE",
                                    headers: {
