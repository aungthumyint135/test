<x-app-layout>
    <x-slot name="title">Create Banner Image</x-slot>
    <div class="flex w-full justify-center">
        <div class="flex w-full max-w-2xl flex-col space-y-5">
            ...
            <div class="rounded-md border border-gray-200">
                <form class="mt-5 bg-white shadow-sm ring-1 ring-gray-900/5 md:col-span-2 md:mt-0 md:rounded-xl" enctype="multipart/form-data" method="post" action="{{ route('portal.heading-banners.store') }}">
                    @csrf
